...
Gem::Specification.new do |spec|
  ...
  # Ship the library and the things a user reads; leave development scaffolding out.
  gemspec = File.basename(__FILE__)
  development_only = %w[bin/ test/ spec/ features/ sig/ .git appveyor Gemfile Rakefile
                        .simplecov AGENTS.md CLAUDE.md context7.json]
